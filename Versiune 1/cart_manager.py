...
<div class="c">
  ...
  <div class="box">
    ...
    <ol class="steps">
      ...
      <li>
        Apasa butonul <strong style="color:#e94560">COPIAZA SCRIPTUL</strong> de mai jos,
        apoi pe targulcartii.ro apasa <code>F12</code> &rarr; tab <code>Console</code> &rarr;
        <code>Ctrl+V</code> &rarr; <code>Enter</code>
      </li>
      <li>
        Asteapta bara de progres (~{est_minutes} min). Cand termina, te duce <strong>automat la cos</strong> &rarr; <strong>Plateste</strong>
      </li>
    </ol>

    <textarea class="script-area" id="scriptArea" readonly onclick="this.select()">{js_for_html}</textarea>
    <button class="bigbtn bigbtn-red" id="copyBtn" onclick="copyScript()">COPIAZA SCRIPTUL</button>
    <div class="copied-msg" id="copiedMsg">COPIAT! Acum mergi pe targulcartii.ro, apasa F12 &rarr; Console &rarr; Ctrl+V &rarr; Enter</div>

    <button class="bigbtn bigbtn-green" id="bmBtn" onclick="prepareBookmarklet()">BUTON FARA CONSOLE (BOOKMARK)</button>
    <div id="bmBox" style="display:none;margin-top:10px;font-size:13px;color:#555">
      <p style="margin-bottom:6px;"><strong>O varianta si mai usoara pentru Andreea:</strong></p>
      <ol style="margin-left:18px;padding-left:0;font-size:13px;line-height:1.5;">
        <li>Trage butonul de mai jos in bara de bookmarks sau click dreapta &rarr; „Bookmark this link”.</li>
        <li>Pe <strong>targulcartii.ro</strong>, deja logata, doar apasa bookmark-ul si cartile se adauga automat in cos.</li>
      </ol>
      <a id="bmLink" href="#"
...
function prepareBookmarklet(){{
  ...
  document.getElementById('bmBox').style.display='block';
}}
</script>
</body>
</html>"""
